...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
       ...
       <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-10">
         <div className="container flex h-12 items-center justify-between px-3 sm:px-4">
           <div className="flex items-center gap-1.5 flex-shrink-0">
             ...
             <h1 className="text-base font-bold sm:text-lg whitespace-nowrap">UTME Prep</h1>
           </div>
        ...
        {isMenuOpen && (
          <nav className="md:hidden bg-background border-t">
            <div className="container flex flex-col gap-3 py-3 px-3 sm:px-4">
              <Link
                to="#features"
                className="text-sm font-medium hover:text-primary"
      ...
      {/* Hero Section */}
      <section className="py-12 sm:py-20 md:py-32 bg-gradient-to-b from-background to-secondary/20">
        <div className="container flex flex-col items-center text-center px-4 sm:px-6">
          ...
          <div className="mt-10 sm:mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 w-full max-w-4xl">
            <div className="flex flex-col items-center">
              <div className="rounded-full bg-primary/10 p-2 sm:p-3 mb-3">
                <BookOpen className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold mb-1">10,000+</h3>
              <p className="text-sm sm:text-base text-muted-foreground">Practice Questions</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="rounded-full bg-primary/10 p-2 sm:p-3 mb-3">
                <BarChart3 className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold mb-1">Detailed</h3>
              <p className="text-sm sm:text-base text-muted-foreground">Performance Analytics</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="rounded-full bg-primary/10 p-2 sm:p-3 mb-3">
                <Trophy className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold mb-1">National</h3>
              <p className="text-sm sm:text-base text-muted-foreground">Leaderboard</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-12 sm:py-20 bg-background">
        <div className="container px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-3">Key Features</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-card border rounded-xl p-5 sm:p-6 shadow-sm">
              <div className="rounded-full bg-primary/10 p-2 sm:p-3 w-fit mb-3">
                <BookOpen className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
              </div>
            ...
            <div className="bg-card border rounded-xl p-5 sm:p-6 shadow-sm">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2">Performance Dashboard</h3>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
                Visual analytics showing speed, accuracy, and subject-specific
                performance metrics.
              </p>
            ...
            <div className="bg-card border rounded-xl p-5 sm:p-6 shadow-sm">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2">Study Recommendations</h3>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
                Personalized topic suggestions and learning resource
                recommendations based on performance gaps.
              </p>
      ...
      {/* How It Works Section */}
      <section id="how-it-works" className="py-12 sm:py-20 bg-secondary/20">
        <div className="container px-4 sm:px-6">
          <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="flex flex-col items-center text-center">
              <div className="rounded-full bg-primary/10 p-3 sm:p-4 mb-3 relative">
                <span className="absolute -top-2 -right-2 bg-primary text-primary-foreground rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs sm:text-sm font-bold">
                  1
                </span>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2">Take Practice Tests</h3>
              <p className="text-sm sm:text-base text-muted-foreground">
                Choose your subjects and start taking realistic UTME practice
                tests with our CBT interface.
              </p>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2">Track Your Progress</h3>
              <p className="text-sm sm:text-base text-muted-foreground">
                Review your performance analytics and follow personalized study
                recommendations to improve.
              </p>
      ...
      {/* Reviews Section */}
      <section id="reviews" className="py-12 sm:py-20 bg-background">
        <div className="container px-4 sm:px-6">
          <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-card border rounded-xl p-5 sm:p-6 shadow-sm">
              ...
              <div className="flex items-center gap-3">
                <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-primary/10 flex items-center justify-center">
                  <span className="font-bold text-primary text-sm sm:text-base">CO</span>
                </div>
                <div>
                  <p className="font-medium text-sm sm:text-base">Chioma Okonkwo</p>
            ...
            <div className="bg-card border rounded-xl p-5 sm:p-6 shadow-sm">
              ...
              <div className="flex items-center gap-3">
                <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-primary/10 flex items-center justify-center">
                  <span className="font-bold text-primary text-sm sm:text-base">EE</span>
                </div>
                <div>
                  <p className="font-medium text-sm sm:text-base">Emeka Eze</p>
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Engineering, UNIBEN
                  </p>
                </div>
            ...
            <div className="bg-card border rounded-xl p-5 sm:p-6 shadow-sm">
              ...
              <div className="flex items-center gap-3">
                <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-primary/10 flex items-center justify-center">
                  <span className="font-bold text-primary text-sm sm:text-base">TB</span>
                </div>
                <div>
                  <p className="font-medium text-sm sm:text-base">Tunde Bakare</p>
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Economics, OAU
                  </p>
                </div>
      ...
      <section className="py-12 sm:py-20 bg-primary text-primary-foreground">
        <div className="container text-center px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">Ready to Ace Your UTME?</h2>
      ...
      <footer className="bg-background border-t py-8 sm:py-12">
        <div className="container px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            <div className="sm:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-lg sm:text-xl font-bold">UTME Prep</h2>
              </div>
            ...
            <div>
              <h3 className="font-bold mb-3 text-sm sm:text-base">Quick Links</h3>
              <ul className="space-y-2">
                <li>
                  <Link
                    to="/"
            ...
            <div>
              <h3 className="font-bold mb-3 text-sm sm:text-base">Legal</h3>
              <ul className="space-y-2">
                <li>
                  <Link
                    to="/privacy"
          ...
          <div className="border-t mt-8 sm:mt-12 pt-6 text-center text-muted-foreground">
            <p className="text-xs sm:text-sm">© {new Date().getFullYear()} UTME Prep. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
